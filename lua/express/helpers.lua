...
express.domain = CreateConVar( "express_domain", "gmod.express", FCVAR_ARCHIVE + FCVAR_REPLICATED,
...
express.domain_cl = CreateConVar( "express_domain_cl", "", FCVAR_ARCHIVE + FCVAR_REPLICATED,
                                  "The client-specific domain of the Express server. If empty, express_domain will be used." )

express.sendDelay = CreateConVar( "express_send_delay", "0.15", FCVAR_ARCHIVE + FCVAR_REPLICATED,
                                  "How long to wait (in seconds) before sending the Express Message ID to the recipient (longer delays will result in increased reliability)" )
